...
FS1_ramdomForest = GridSearchCV(estimator= FS1_rf_model, param_grid=pram_grid,
...
FS2_RandomForest = GridSearchCV(estimator= FS2_rf_model, param_grid=pram_grid,
                           cv = cv, n_jobs=-1, verbose = 2)
...
FS3_RandomForest = GridSearchCV(estimator= rf, param_grid=pram_grid,
                           cv = cv, n_jobs=-1, verbose = 2)
...
FS1_XGBoost = GridSearchCV(model, param_grid=param_grid, cv=cv, scoring='accuracy', n_jobs=-1)
...
FS2_XGBoost = GridSearchCV(estimator= FS2_xg_model, param_distributions=pram_grid,
                           cv = cv, n_jobs=-1, verbose = 2)
